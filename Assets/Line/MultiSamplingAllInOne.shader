Shader "Line/MultiSamplingAllInOne"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float2 GetSampleDelta(uint index, uint stepCount, uint sqrtStepCount)
            {
                ...
                case 3: return GetSampleDeltaHammersley(index, stepCount);
                default: return 0;
                }
            }
            ...
            float4 frag(v2f IN) : COLOR
            {
                ...
                {
                    const float2 localXY = GetSampleDelta(i, stepCount, sqrtStepCount);
