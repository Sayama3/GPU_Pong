...
public partial class DefaultCameraMover : LoadableBehaviour
{
    ...
    private UnityEngine.GUIStyle customLabelStyle;
    ...
    protected void LateUpdate() 
    {
        ...
        float speedFactor = this.MainSpeed * UnityEngine.Time.deltaTime;
        UnityEngine.Vector3 keyboardMoveThisFrame = propulsion * speedFactor;
        ...
        {
            worldTranslation += new UnityEngine.Vector3(0, -speedFactor, 0);
        }
